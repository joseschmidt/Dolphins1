...
class PracticesControllerTest < ActionController::TestCase
  ...
  test "should create practice" do
    assert_difference('Practice.count') do
      post :create, practice: { comment: @practice.comment, compstatus: @practice.compstatus, group: @practice.group, lane: @practice.lane, practicedate: @practice.practicedate }
    end
  ...
  test "should update practice" do
    patch :update, id: @practice, practice: { comment: @practice.comment, compstatus: @practice.compstatus, group: @practice.group, lane: @practice.lane, practicedate: @practice.practicedate }
    assert_redirected_to practice_path(assigns(:practice))
  end
